...
# to check if the connection succeds
# nc -vz 34.66.67.234 9092

# to check the returned metadata(advertised listerners)
# kafkacat -b 34.66.67.234:9092 -L

# Using kafkacat in producer mode (-C) from your local machine, try and read from the topic.
# kafkacat -b 34.66.67.234:9092 -C -t test
